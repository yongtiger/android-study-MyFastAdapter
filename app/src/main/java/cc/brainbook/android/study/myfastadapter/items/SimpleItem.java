...
public class SimpleItem extends AbstractItem<SimpleItem, SimpleItem.ViewHolder> implements IDraggable<SimpleItem, IItem> {
    public boolean isHeader;    ///[HeaderHelper]判断item和position是否为头部点击
    ...
    ///[HeaderHelper]判断item和position是否为头部点击
    public SimpleItem isHeader(boolean isHeader) {
...
//            ButterKnife.bind(this, view);
            ...
            description = view.findViewById(R.id.material_drawer_description);
        }
